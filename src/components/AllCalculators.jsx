    ...
    return (
        <>
            <div className=' max-w-screen mx-auto my-5'>
                <div className='container flex flex-row justify-center  space-y-5 flex-wrap items-center '>
                    <br />
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mx-2">
                        <a href="#">
                            <img class="rounded-t-lg h-[250px] w-[100%]" src="/images/calculator-bg-1.jpg" alt="" />
                        </a>
                        <div class="p-5">
                            <a href="#">
